...
const products = [
  ...
  { name: 'CHILDREN JACKETS (SPRING, SUMMER)', image: 'https://images.unsplash.com/photo-1519238263530-99bdd11df2ea?w=400&q=80' },
  { name: 'CHILDREN JACKETS (WINTER)', image: 'https://images.unsplash.com/photo-1445796886651-d31a2c15f3ce?w=400&q=80' },
  { name: 'CHILDREN JACKETS (WINTER II)', image: 'https://images.unsplash.com/photo-1503919545889-aef636e10ad4?w=400&q=80' },
  { name: 'CHILDREN PANTS (JEANS)', image: 'https://images.unsplash.com/photo-1519238263530-99bdd11df2ea?w=400&q=80' },
  { name: 'CHILDREN POLYESTER MIX', image: 'https://images.unsplash.com/photo-1622290291468-a28f7a7dc6a8?w=400&q=80' },
  { name: 'CHILDREN RUMMAGE 0–3', image: 'https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?w=400&q=80' },
  { name: 'CHILDREN RUMMAGE 4–14 (L/S)', image: 'https://images.unsplash.com/photo-1503944583220-79d8926ad5e2?w=400&q=80' },
  { name: 'CHILDREN RUMMAGE 4–14 (SPRING, SUMMER)', image: 'https://images.unsplash.com/photo-1471286174890-9c112ffca5b4?w=400&q=80' },
  ...
  { name: 'CHILDREN WINTER MIX 4–14', image: 'https://images.unsplash.com/photo-1445796886651-d31a2c15f3ce?w=400&q=80' },
  { name: 'COATS, JACKETS', image: 'https://images.unsplash.com/photo-1544923246-77307dd628b8?w=400&q=80' },
  ...
  { name: 'HATS, SCARFS', image: 'https://images.unsplash.com/photo-1576871337632-b9aef4c17ab9?w=400&q=80' },
  { name: 'HATS, SCARFS, GLOVES (ADULT)', image: 'https://images.unsplash.com/photo-1510598969022-c4c6c5d05769?w=400&q=80' },
  { name: 'HATS, SCARFS, GLOVES (CHILDREN)', image: 'https://images.unsplash.com/photo-1544965838-54f5e3a0b9d9?w=400&q=80' },
  ...
  { name: 'JACKETS (SPRING & FALL) SIZE PLUS', image: 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=400&q=80' },
  ...
  { name: 'JOGGING PANTS (POLYESTER)', image: 'https://images.unsplash.com/photo-1506629082955-511b1aa562c8?w=400&q=80' },
  { name: 'JOGGING PANTS MIX', image: 'https://images.unsplash.com/photo-1552902865-b72c031ac5ea?w=400&q=80' },
  ...
  { name: 'LADIES MIX, PLUS SIZE, PREMIUM', image: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=400&q=80' },
  ...
  { name: 'LADIES TOPS', image: 'https://images.unsplash.com/photo-1564257631407-4deb1f99d992?w=400&q=80' },
  ...
  { name: 'MENS SHIRTS L/S', image: 'https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=400&q=80' },
  { name: 'MENS QUILTED SHIRTS', image: 'https://images.unsplash.com/photo-1598032895397-b9472444bf93?w=400&q=80' },
  { name: 'MENS SUIT PANTS', image: 'https://images.unsplash.com/photo-1507680434567-5739c80be1ac?w=400&q=80' },
  ...
  { name: 'MENS UNDERWEAR', image: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=400&q=80' },
  { name: 'MENS PANTS PLUS SIZE', image: 'https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=400&q=80' },
  { name: 'OVERCOATS / RAINCOATS', image: 'https://images.unsplash.com/photo-1545594861-3bef43ff2fc8?w=400&q=80' },
  { name: 'PLUSH PAJAMAS', image: 'https://images.unsplash.com/photo-1519238263530-99bdd11df2ea?w=400&q=80' },
  ...
  { name: 'SKI SUITS', image: 'https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=400&q=80' },
  ...
  { name: 'SWEATERS', image: 'https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=400&q=80' },
  { name: 'SWEATSHIRTS (ADULT MIX)', image: 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=400&q=80' },
  { name: 'TURTLENECKS', image: 'https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=400&q=80' },
]
