...
// Product data with relevant image URLs from Unsplash
const products = [
  ...
  { name: 'CHILDREN JACKETS (WINTER)', image: 'https://images.unsplash.com/photo-1732001804554-580de1dc659e?q=80&w=871&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
  { name: 'CHILDREN JACKETS (WINTER II)', image: 'https://images.unsplash.com/photo-1503944583220-79d8926ad5e2?w=400&q=80' },
  { name: 'CHILDREN PANTS (JEANS)', image: 'https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=400&q=80' },
  ...
  { name: 'CHILDREN RUMMAGE 4–14 (L/S)', image: 'https://images.unsplash.com/photo-1518831959646-742c3a14ebf7?w=400&q=80' },
  ...
  { name: 'CHILDREN SWEATSHIRTS/SWEATPANTS MIX', image: 'https://images.unsplash.com/photo-1602407294553-6ac9170b3ed0?w=400&q=80' },
  { name: 'CHILDREN WINTER MIX 4–14', image: 'https://images.unsplash.com/photo-1604917621956-10dfa7cce2e7?w=400&q=80' },
  ...
  { name: 'JOGGING PANTS (POLYESTER)', image: 'https://images.unsplash.com/photo-1556906781-9a412961c28c?w=400&q=80' },
  { name: 'JOGGING PANTS MIX', image: 'https://images.unsplash.com/photo-1552902865-b72c031ac5ea?w=400&q=80' },
  { name: 'LADIES BLAZERS – JACKETS', image: 'https://images.unsplash.com/photo-1548454782-15b189d129ab?w=400&q=80' },
  ...
  { name: 'LADIES BLOUSES L/S', image: 'https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=400&q=80' },
  { name: 'LADIES BLOUSES POLY', image: 'https://images.unsplash.com/photo-1551048632-24e444b48a3e?w=400&q=80' },
  ...
  { name: 'LADIES PANTS CASUAL', image: 'https://images.unsplash.com/photo-1584370848010-d7fe6bc767ec?w=400&q=80' },
  { name: 'LADIES PANTS DRESSY', image: 'https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?w=400&q=80' },
  { name: 'LADIES JEANS', image: 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?w=400&q=80' },
  { name: 'LADIES PANTS PLUS SIZE', image: 'https://images.unsplash.com/photo-1506629082955-511b1aa562c8?w=400&q=80' },
  ...
  { name: 'MENS PANTS CARGO', image: 'https://images.unsplash.com/photo-1517438476312-10d79c077509?w=400&q=80' },
  ...
  { name: 'MENS QUILTED SHIRTS', image: 'https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?w=400&q=80' },
  { name: 'MENS SUIT PANTS', image: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=400&q=80' },
  ...
  { name: 'SOCKS, PANTYHOSE', image: 'https://images.unsplash.com/photo-1582966772680-860e372bb558?w=400&q=80' },
  { name: 'SPORT WEAR', image: 'https://images.unsplash.com/photo-1571902943202-507ec2618e8f?w=400&q=80' },
